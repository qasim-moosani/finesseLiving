...
export const workData = [
    {
        id:1,
        image:'/assets/img/svg/work-1.svg',
    ...
    {
        id:2,
        image:'/assets/img/svg/work-2.svg',
    ...
    {
        id:3,
        image:'/assets/img/svg/work-3.svg',
...
export const propertyData = [
    {
        id:1,
        image:['/assets/img/p-1.jpg','/assets/img/p-9.jpg','/assets/img/p-10.jpg'],
        tag:['Verified'],
        tag2:'For Rent',
        type:'Apartment',
    ...
    {
        id:2,
        image:['/assets/img/p-2.jpg','/assets/img/p-6.jpg','/assets/img/p-8.jpg'],
        tag:['SuperAgent'],
        tag2:'For Sell',
        type:'House',
    ...
    {
        id:3,
        image:['/assets/img/p-3.jpg','/assets/img/p-5.jpg','/assets/img/p-7.jpg'],
        tag:['Verified','New'],
        tag2:'For Rent',
        type:'Building',
        name:'The Green Canton Chrysler',
    ...
    {
        id:4,
        image:['/assets/img/p-4.jpg','/assets/img/p-6.jpg','/assets/img/p-9.jpg'],
        tag:['SuperAgent'],
        tag2:'For Sell',
        type:'Condos',
    ...
    {
        id:5,
        image:['/assets/img/p-5.jpg','/assets/img/p-12.jpg','/assets/img/p-13.jpg'],
        tag:['Verified','New'],
        tag2:'For Rent',
        type:'Villa',
    ...
    {
        id:6,
        image:['/assets/img/p-6.jpg','/assets/img/p-7.jpg','/assets/img/p-11.jpg'],
        tag:['SuperAgent'],
        tag2:'For Sell',
        type:'Building',
    ...
    {
        id:7,
        image:['/assets/img/p-22.jpg','/assets/img/p-3.jpg','/assets/img/p-5.jpg'],
        tag:['SuperAgent'],
        tag2:'For Sell',
        type:'Condos',
        name:'The Red Freedom Tower',
    ...
    {
        id:8,
        image:['/assets/img/p-12.jpg','/assets/img/p-13.jpg','/assets/img/p-14.jpg'],
        tag:['Verified','New'],
        tag2:'For Rent',
        type:'Villa',
        name:'The Donald Dwelling',
    ...
    {
        id:9,
        image:['/assets/img/p-7.jpg','/assets/img/p-8.jpg','/assets/img/p-12.jpg'],
        tag:['SuperAgent'],
        tag2:'For Sell',
        type:'Building',
        name:'Red Tiny Hearst Castle',
...
export const explorePlace = [
    {
        image:'assets/img/ct-1.png',
        loction:'Chikago',
        property:'43 Properties'
    },
    {
        image:'assets/img/ct-2.png',
        loction:'San Diego',
        property:'35 Properties'
    },
    {
        image:'assets/img/ct-3.png',
        loction:'San Francisco',
        property:'42 Properties'
    },
    {
        image:'assets/img/ct-4.png',
        loction:'Jacksonville',
        property:'47 Properties'
    },
    {
        image:'assets/img/ct-5.png',
        loction:'Virginia Beach',
        property:'17 Properties'
    },
    {
        image:'assets/img/ct-6.png',
        loction:'Philadelphia',
        property:'37 Properties'
    },
    {
        image:'assets/img/ct-7.png',
        loction:'Seattle',
        property:'32 Properties'
    },
    {
        image:'assets/img/ct-8.png',
        loction:'Houston',
        property:'26 Properties'
    },
    {
        image:'assets/img/ct-9.png',
        loction:'Los Angeles',
        property:'18 Properties'
    },
    {
        image:'assets/img/ct-10.png',
        loction:'Denver',
        property:'12 Properties'
    },
    {
        image:'assets/img/ct-11.png',
        loction:'Oklahoma City',
        property:'22 Properties'
    },
    {
        image:'assets/img/ct-12.png',
        loction:'Phoenix',
        property:'15 Properties'
    },
    {
        image:'assets/img/ct-13.png',
        loction:'New York',
